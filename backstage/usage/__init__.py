...
class Usage(Enum):
    ...
    AUTOSEND = "autosend <var> ..."
    BRANCH = "& <subtask> [<arguments> ...]"
    BREAK = "break"
    BROWSE = "browse [files|dirs|entries] in <dirname_var>"
    ...
    FIND = ("find [all] (paths|files|dirs) in <dirname_var>",
              "... [matching <regex_var>]",
              "... [and (accessed|modified|created) (at|after|before|between) <timestamp_var> [and <timestamp_var>]]")
    ...
    LINE = "(=|-) ..."
    MOVE = "move <path_var> to <dirname_var>"
    PASS = "pass"
    POKE = "poke <path_var>"
