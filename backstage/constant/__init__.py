...
CONFIG_OPTIONS = ("FailFast", "ReportException", "ShowTraceback", "AutoLineBreak")

ENVIRONMENT_VARS = ("ARGS", "CWD", "DATE", "EMPTY", "ERROR",
                    "EXCEPTION", "FALSE", "HOME", "LINE", "N",
                    "NOW", "ONE", "OS", "OUTPUT", "R", "RANDOM",
                    "SPACE", "STDERR", "STDIN", "STDOUT", "TASK",
                    "TIME", "TIMEOUT", "TMP", "TRASH", "TRUE", "ZERO")
...
ELEMENTS = {"append": "APPEND",         "assert": "ASSERT",     "&": "BRANCH",
            ...
            "enter": "ENTER",           "expose": "EXPOSE",     "fail": "FAIL",
            "find": "FIND",             "for": "FOR",           "from": "FROM",
            "get": "GET",               "if": "IF",             "interface": "INTERFACE",
            "-": "LINE",                "=": "LINE",            "move": "MOVE",
            "pass": "PASS",             "poke": "POKE",         "prepend": "PREPEND",
            ":": "PRINT",               "push": "PUSH",         "read": "READ",
            "replace": "REPLACE",       "return": "RETURN",     "set": "SET",
            "sleep": "SLEEP",           "$": "SPAWN",           "split": "SPLIT",
            "spot": "SPOT",             "store": "STORE",       "~": "THREAD",
